...
| `prometheusRule.enabled` | `false` | Alerts: operator down, subnet nearly full or full, target down, CIDR overlap, stale inventory, unmanaged resources, claims and imports stuck unfulfilled. |
