...
*/}}
{{- define "aws-subnet-operator.dashboard.fullname" -}}
{{- printf "%s-dashboard" (include "aws-subnet-operator.fullname" . | trunc 53 | trimSuffix "-") -}}
{{- end -}}

{{- define "aws-subnet-operator.dashboard.selectorLabels" -}}
app.kubernetes.io/name: {{ printf "%s-dashboard" (include "aws-subnet-operator.name" . | trunc 53 | trimSuffix "-") }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}

{{- define "aws-subnet-operator.dashboard.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{ include "aws-subnet-operator.dashboard.selectorLabels" . }}
