...
![A Grafana dashboard with an unmanaged resources tile, utilisation against an 80 percent threshold, a firing UnmanagedNetworkResource alert and the Slack message it sends](https://hypersurgery.dev/article/img/fig6-grafana.png?v=2)
