...
subnet-0b19c7d2   vpc-0aaa   10.20.2.0/24   eu-central-1b   44         82       team-web
subnet-07c8d9e0   vpc-0bbb   10.30.4.0/22   eu-west-1a      812        80       <none>

$ kubectl get hssubnet -l network.hypersurgery.dev/account=222222222222
$ kubectl get nscope organization -o yaml | yq '.status'
```
