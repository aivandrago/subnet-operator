...
func SetupResourceImportWebhookWithManager(mgr ctrl.Manager, providers *provider.Registry, writesEnabled bool) error {
	return ctrl.NewWebhookManagedBy(mgr, &networkv1.ResourceImport{}).
...
// +kubebuilder:webhook:path=/mutate-network-hypersurgery-dev-v1-resourceimport,mutating=true,failurePolicy=ignore,sideEffects=None,groups=network.hypersurgery.dev,resources=resourceimports,verbs=create;update,versions=v1,name=mresourceimport-v1.kb.io,admissionReviewVersions=v1
...
func (d *ResourceImportDefaulter) Default(ctx context.Context, obj *networkv1.ResourceImport) error {
	stampCreatedBy(ctx, obj)
	if obj.Spec.ResourceID != "" {
		if obj.Labels == nil {
			obj.Labels = map[string]string{}
		}
		setIfEmpty(obj.Labels, networkv1.LabelResource, obj.Spec.ResourceID)
		setIfEmpty(obj.Labels, networkv1.LabelScope, obj.Spec.ScopeRef)
		setIfEmpty(obj.Labels, networkv1.LabelAccount, obj.Spec.Account)
		setIfEmpty(obj.Labels, networkv1.LabelRegion, obj.Spec.Region)
	}
...
// +kubebuilder:webhook:path=/validate-network-hypersurgery-dev-v1-resourceimport,mutating=false,failurePolicy=fail,sideEffects=None,groups=network.hypersurgery.dev,resources=resourceimports,verbs=create;update,versions=v1,name=vresourceimport-v1.kb.io,admissionReviewVersions=v1
...
func (v *ResourceImportValidator) ValidateCreate(ctx context.Context, obj *networkv1.ResourceImport) (
...
func (v *ResourceImportValidator) ValidateUpdate(ctx context.Context, oldObj, newObj *networkv1.ResourceImport) (
	admission.Warnings, error) {
	...
	if oldObj.Status.State == networkv1.ImportApplied && !newObj.Spec.DryRun {
...
func (v *ResourceImportValidator) ValidateDelete(_ context.Context, _ *networkv1.ResourceImport) (
	admission.Warnings, error) {
	return nil, nil
}

// Validate is everything that is checked on both create and update.
func (v *ResourceImportValidator) Validate(ctx context.Context, imp *networkv1.ResourceImport) (
	admission.Warnings, error) {
	spec := field.NewPath("spec")
	var errs field.ErrorList
...
func (v *ResourceImportValidator) validateAgainstInventory(ctx context.Context, imp *networkv1.ResourceImport,
...
func missingRequiredTags(scope *networkv1.NetworkScope, wanted, existing map[string]string) []string {
