...
// Default labels the import with the resource it refers to and fills in requestedBy.
//
...
//
// requestedBy defaults to the user the API server authenticated, because "who asked for
// this" is the question a reviewer asks of an import months later, and the person applying
// it rarely thinks to write their own name.
