...
const (
	...
	// EventNamespacesUnrestricted is on a NetworkScope without a namespaceSelector, which any
	// namespace may use. Emitted once per change of the spec.
...
func createdBy(obj client.Object, webhooksEnabled bool) string {
	...
	if v := obj.GetAnnotations()[awsv1alpha1.AnnotationCreatedBy]; v != "" {
		return v
	}
	return audit.CreatedByUnknown
}
