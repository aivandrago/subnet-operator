...
func (r *SubnetClaimReconciler) scopeFor(ctx context.Context, claim *awsv1alpha1.SubnetClaim) (
	scope *awsv1alpha1.NetworkScope, target inventory.Target, reason, msg string, err error) {
...
func namespaceRefusal(ctx context.Context, reader client.Reader, scope *awsv1alpha1.NetworkScope,
