...
type ResourceImportSpec struct {
	...
	// +kubebuilder:validation:Pattern=`^(vpc|subnet)-[0-9a-f]+$`
	// +required
...
// +kubebuilder:deprecatedversion:warning="aws.hypersurgery/v1alpha1 ResourceImport is deprecated and removed in 0.9; the operator migrates it to network.hypersurgery.dev/v1beta1 ResourceImport, use that instead"
