...
// +kubebuilder:deprecatedversion:warning="aws.hypersurgery/v1alpha1 Subnet is deprecated and removed in 0.9; network.hypersurgery.dev/v1beta1 Subnet replaces it"
